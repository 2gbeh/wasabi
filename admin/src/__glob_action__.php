...
$list_nav = array(
    ...
    /////////////////////////////////////////////////////////////////
    'Direct Deposits' => array(
        array('view_directs_cr.php', 'fas fa-tasks', 'View Records'),
    ),
    /////////////////////////////////////////////////////////////////
    'My Account' => array(
...
$list_aside_top = array(
    ...
    array('view_directs_cr.php', 'fas fa-handshake', 'Direct Deposits'),
    array('view_ledgers_dr.php', 'fas fa-credit-card', 'Manage Withdrawals', $sizeof_ledger_dr),
    // array('view_directs_dr.php', 'fas fa-wallet', 'Direct Withdrawals'),
