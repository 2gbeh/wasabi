  ...
  <main class="tmp-base">
        ...
        <tr valign="bottom">
          <td>
            <div class="fieldset-lft">
          	  <input type="search" name="q" placeholder="Search by email.." list="hint_email" style="padding-top:13px; padding-left:50px;" required />
              <?php echo $hint_email; ?>
    ...
    <table class="tmp-table" border="0">
      <tr>
        ...
        <th>BTC Address</th>
        <th nw>Balance ($)</th>
        <th nw><a title="Referral Bonus">Profit ($)</a></th>
        <th nw>Trading Interest ($)</th>
        <th nw>Investment Deposit ($)</th>
        <th>Date Created</th>
        <th>&nbsp;</th>
      </tr>
