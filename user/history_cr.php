                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Deposit History</h5>
                                            <p class="text-muted m-b-10">View all deposits (CR) and withdrawals (DR) performed on your trading account</p>
...
<tr>
 ...
 <td colspan=7 align="center"><b><?php echo $caption_cr; ?></b></td>
</tr>
<tr>
 <th class=inheader><nobr>Transaction ID</nobr></th>
 <th class=inheader>Amount ($)</th>
 <th class=inheader><nobr>Plan</nobr></th>
