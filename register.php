                                ...
                                <img src="https://intcmovement.com/wp-content/uploads/2023/01/bingx.png" class="login-img h-100" alt="logo" />
                                    ...
                                    <?php ctx_err($error, $errno);?>
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" name="names" value="<?php echo $_POST['names']; ?>" class="form-control" required />
                                        </div>

                                        <div class="form-group mt-4">
                                            <label>Crypto Address</label>
                                            <input type="search" name="wal" value="<?php echo $_POST['wal']; ?>" placeholder="Ex. BTC Wallet Address" class="form-control" />
                                        </div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="tel" name="phone" value="<?php echo $_POST['phone']; ?>" class="form-control"
                                        ...
                                        <div class="form-group mt-4">
                                            <label>Address</label>
                                            <input type="text" name="address" value="<?php echo $_POST['address']; ?>" class="form-control"
                                                placeholder="Enter your address" required />
                                        </div>
                                        
                                        <div class="form-group mt-4">
                                            <label>Country</label>
                                                    <select class="form-control form-select" name="country" style="border-bottom:1px solid #ccc;" required>
                                                        <option></option>
...
<option value="Zimbabwe">Zimbabwe</option>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="input-group col-lg-12" id="show_hide_password">
                                                <input class="form-control border-right-0" type="password"
                                                    name="password" value="<?php echo $_POST['password']; ?>" ondblclick="togglePassword()" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="input-group col-lg-12" id="show_hide_password">
                                                <input class="form-control border-right-0" type="password" 
                                                name="password_cfm" value="<?php echo $_POST['password_cfm']; ?>" ondblclick="togglePassword()" required />
                                            </div>
                                        </div>
